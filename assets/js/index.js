...
const menuToggleButton = document.querySelector('.menu-togle-button');
...
const themeToggleButton = document.querySelector('.theme-togle-button');
...
sr.reveal('.scroll-reveal-left', {origin: 'left'});sr.reveal('.scroll-reveal-left', {origin: 'left'});
